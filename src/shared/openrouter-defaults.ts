...
inline p5 sketch rules:
- use inline syntax directly in front or back text: [p5:width:height]...code...[/p5]
- width: 100-1200, height: 100-900
...
- example: [p5:300:200]p.setup=()=>{p.createCanvas(WIDTH,HEIGHT);p.background(220);p.fill(255,0,0);p.ellipse(WIDTH/2,HEIGHT/2,100,100)}[/p5]
- multiple sketches can appear in the same field
- use for visualizations, diagrams, animations that enhance learning`;
...
notes:
- p5 sketches are now inline in text using [p5:width:height]...code...[/p5] syntax
- do not include a separate p5 object, embed sketches directly in front/back text

constraints:
- name: 1-64 chars
- front/back: 1-50000 chars (large content allowed)
